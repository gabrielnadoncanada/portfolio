                ...
                <Slider {...settings}>
                    <div className="card-single pro_1">
                        <div className="card-text text-white">
                            ...
                            <a className="btn btn-primary btn-action" href="http://yntconstruction.com/" target="_blank">Voir plus</a>
                        </div>
                    </div>
                    <div className="card-single pro_2">
                        <div className="text-white">
                            ...
                            <a className="btn btn-primary btn-action" href="http://miquelie.planethoster.world/wordpress/" target="_blank">Voir plus</a>
                        </div>
                    </div>
                    <div className="card-single pro_3">
                        ...
                        <h1>NuScratch</h1>
                            ...
                            <a className="btn btn-primary btn-action" href="https://gabrielnadoncanada.github.io/reactalbum/#/" target="_blank">Voir plus</a>
                        </div>
                    </div>
