              ...
              <div className="row text-center">
                  ...
                  <div className="feature-list">
                    <div className="card-icon">
                      <div className="card-img">
                        <svg id="Layers_1_" width="120" viewBox="0 0 64 64">
                    ...
                    <div className="card-text">
                      <h3>Développement <br />Front-End</h3>
                ...
                <div className="col-sm-6">
                  <div className="feature-list">
                    <div className="card-icon">
                      <div className="card-img">
                        <svg id="Layers_1_" viewBox="0 0 64 64" width="120">
                    ...
                    <div className="card-text">
                      <h3>Développement <br />Back-End</h3>
